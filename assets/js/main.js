(function($) {
  ...
  */
  ...
  /*---------- 01. On Load Function ----------*/
        ...
        form.addEventListener('submit', function(event) {
            ...
            fetch(form.action, {
                ...
                if (response.ok) {
                    ...
                    formMessages.className = 'form-messages success mb-0 mt-3';
                    form.reset();
                } else {
                    response.json().then(data => {
                        ...
                        formMessages.className = 'form-messages error mb-0 mt-3';
                    })
                }
            }).catch(error => {
                formMessages.innerHTML = "Oops! There was a problem submitting your form";
    ...
    // Call sendContact function when the DOM is fully loaded
    document.addEventListener('DOMContentLoaded', sendContact);
